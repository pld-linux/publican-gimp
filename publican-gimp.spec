Summary:	Publican documentation template files for GIMP
Summary(pl.UTF-8):	Pliki szablonów dokumentacji Publicana dla projektu GIMP
Name:		publican-gimp
Version:	1.0
Release:	1
License:	FDL
...
documentation for GIMP with Publican.

%description -l pl.UTF-8
Ten pakiet udostępnia wspólne pliki oraz szablony wymagane do
budowania dokumentacji dla projektu GIMP przy użyciu Publicana.
...
%doc COPYING README
%{_datadir}/publican/Common_Content/gimp
